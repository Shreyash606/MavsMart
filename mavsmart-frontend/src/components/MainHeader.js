      ...
      <div className="container mx-auto flex items-center justify-between p-4">
        ...
        <nav className="space-x-4 flex items-center">
          ...
          {isLoggedIn ? (
            ...
            <button
              type="button"
              className="text-white bg-[#0064b1] hover:bg-slate-500 hover:text-black focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2.5 py-2 text-center inline-flex items-center me-2 sm:px-5 sm:py-2.5"
            >
